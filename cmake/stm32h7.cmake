...
macro(define_target_stm32h7 subfamily size)
    function(target_stm32h7${subfamily}x${size} name)
        ...
        set(definitions
            ...
            # Only H7 support right now is H743, which is only
            # available in a single size, so stm32h743xx.h
            # already defines this constant. Leave it commented
            # for now, since future H7 targets might need it.
